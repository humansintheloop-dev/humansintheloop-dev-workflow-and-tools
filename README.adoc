...
The workflow uses custom slash commands that need to be installed. You can install using either slash commands (inside a Claude Code session) or shell commands.
