...
* Run Claude Code in a secure sandbox using [Isolarium](https://github.com/humansintheloop-dev/isolarium/tree/main)
...
The `i2code implement` command provides the option of running Claude Code in a secure sandbox using [Isolarium](https://github.com/humansintheloop-dev/isolarium/tree/main).
