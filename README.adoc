...
* The `i2code` CLI tool — a UV-installable Python CLI for plan file management (reading, updating, and structuring implementation plans)
...
The `i2code` CLI tool provides structured plan file management commands used by the `plan-file-management` skill to enable Claude to efficiently read and edit plan files.
