...
def _parse_thread(command_name, title, introduction, tasks_json):
...
def insert_thread_before_cmd(plan_file, before, title, introduction, tasks, rationale):
    ...
    new_thread = _parse_thread("insert-thread-before", title, introduction, tasks)
...
def insert_thread_after_cmd(plan_file, after, title, introduction, tasks, rationale):
    ...
    new_thread = _parse_thread("insert-thread-after", title, introduction, tasks)
    with with_error_handling():
...
def replace_thread_cmd(plan_file, thread, title, introduction, tasks, tasks_file, rationale):
    ...
    new_thread = _parse_thread("replace-thread", title, introduction, tasks_json)
    with with_error_handling():
