...
@pytest.mark.unit
class TestGithubActionsMonitorWaitForWorkflowCompletion:
    """GithubActionsMonitor.wait_for_workflow_completion(branch, head_sha) delegates to gh_client or skips."""

    def test_wait_for_workflow_completion_delegates_to_gh_client(self, capsys):
        ...
        monitor.wait_for_workflow_completion("idea/test/01-setup", "abc123")
    ...
    def test_wait_for_workflow_completion_passes_timeout_to_gh_client(self):
    ...
    def test_wait_for_workflow_completion_skips_when_skip_ci_wait_is_true(self):
        fake_gh = FakeGitHubClient()
        monitor = GithubActionsMonitor(
    ...
    def test_wait_for_workflow_completion_reports_failure(self, capsys):
        fake_gh = FakeGitHubClient()
        fake_gh.set_workflow_completion_result(
