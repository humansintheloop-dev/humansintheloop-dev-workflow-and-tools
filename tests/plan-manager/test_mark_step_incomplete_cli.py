"""CLI integration tests for mark-step-incomplete command."""

from click.testing import CliRunner

from i2code.plan.task_cli import mark_step_incomplete_cmd
...
class TestMarkStepIncompleteCli:
    """CLI integration: mark-step-incomplete writes file and outputs confirmation."""

    def test_marks_step_incomplete_and_writes_file(self, tmp_path):
    ...
    def test_outputs_confirmation_message(self, tmp_path):
        ...
        assert "Marked step 1 of task 1.1 as incomplete" in result.output

    def test_error_for_already_incomplete_step(self, tmp_path):
        plan_file = tmp_path / "plan.md"
